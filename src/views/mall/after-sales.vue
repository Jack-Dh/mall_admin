<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.userId" clearable class="filter-item" style="width: 200px;" placeholder="请输入退款编号"/>
      <el-input v-model="listQuery.orderSn" clearable class="filter-item" style="width: 200px;" placeholder="请输入订单编号"/>
      <el-select v-model="listQuery.orderStatusArray" style="width: 200px" class="filter-item" placeholder="请选择售后状态">
        <el-option v-for="item in statusMapNew" :value="item.label"/>
      </el-select>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="退款编号" prop="userId"/>
      ...
      <el-table-column align="center" label="退款方式" prop="payTime"/>
      <el-table-column align="center" label="退款金额" prop="orderPrice"/>
      <el-table-column align="center" label="申请时间" prop="payTime"/>
      ...
      <el-table-column align="center" label="操作" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button style="width: 80px" v-permission="['GET /admin/order/detail']" type="info" size="mini"
                     @click="handleDetail(scope.row)">售后详情
          </el-button>
