...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Integral',
        meta: {
          perms: ['GET /admin/user/Integral'],
          title: '积分策略',
          noCache: true
        }
      },
      {
        path: 'Integral_obtain',
        component: () => import('@/views/user/Integral_obtain'),
        name: 'Integral_obtain',
        meta: {
          perms: ['GET /admin/user/Integral_obtain'],
          title: '积分获取',
          noCache: true
        }
      },
